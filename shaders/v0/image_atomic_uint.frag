...
// uint uimage2D at set 0, binding 0, whose descriptor is the same 32-byte
...
layout(set = 0, binding = 0, r32ui) uniform uimage2D target;
...
void main()
{
    ...
    imageAtomicAdd(target, ivec2(quarter, 0), 1u);
    imageAtomicAdd(target, ivec2(quarter, 1), 2u);
