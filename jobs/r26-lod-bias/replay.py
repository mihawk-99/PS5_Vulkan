...
"""Replay the sampler-bias and original mip captures without tolerances."""
import os
from pathlib import Path
import subprocess
import tempfile
root = Path.cwd()
golden = root / 'golden/r26-lod-bias/run-1.json'
work = Path(tempfile.mkdtemp(prefix='r26-replay-', dir=root / 'build'))
for case in ('r26-lod-bias', 'c7-mip-nearest', 'c7-mip-linear'):
    directory = work / case
    directory.mkdir()
