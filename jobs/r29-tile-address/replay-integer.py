...
"""Replay the completed optimized-mip and upload captures without tolerances."""
import os
from pathlib import Path
import subprocess
import tempfile
root = Path.cwd()
golden = root / 'golden/r29-half-blit-capture/run-1.json'
work = Path(tempfile.mkdtemp(prefix='r29-replay-', dir=root / 'build'))
for case in ('r16-mip-blit', 'c7-mip-upload'):
    directory = work / case
    directory.mkdir()
