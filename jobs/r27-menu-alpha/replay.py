...
"""Replay the menu-alpha and constant-blend captures without tolerances."""
import os
from pathlib import Path
import subprocess
import tempfile
root = Path.cwd()
golden = root / 'golden/r27-menu-alpha/run-1.json'
work = Path(tempfile.mkdtemp(prefix='r27-replay-', dir=root / 'build'))
for case in ('r27-menu-alpha-raw', 'r27-menu-alpha', 'v0-blend-constant'):
    directory = work / case
    directory.mkdir()
